...
router.post('/colleges/:collegeId/reverify', (0, adminAuth_1.checkPermission)('approve_colleges'), admin_1.reverifyCollege);
...
router.post('/colleges/:collegeId/reactivate', (0, adminAuth_1.checkPermission)('manage_users'), admin_1.reactivateCollege);
...
router.post('/recruiters/:recruiterId/reverify', (0, adminAuth_1.checkPermission)('approve_recruiters'), admin_1.reverifyRecruiter);
...
router.post('/recruiters/:recruiterId/reactivate', (0, adminAuth_1.checkPermission)('manage_users'), admin_1.reactivateRecruiter);
...
router.post('/colleges/:collegeId/message', (0, adminAuth_1.checkPermission)('send_messages'), admin_1.sendMessageToCollege);
router.post('/recruiters/:recruiterId/message', (0, adminAuth_1.checkPermission)('send_messages'), admin_1.sendMessageToRecruiter);
router.post('/broadcast/colleges', (0, adminAuth_1.checkPermission)('send_broadcasts'), admin_1.sendBroadcastToColleges);
router.post('/broadcast/recruiters', (0, adminAuth_1.checkPermission)('send_broadcasts'), admin_1.sendBroadcastToRecruiters);
