  ...
  const testimonials = [
    {
      ...
      rating: 5,
      message: 'Thank you!',
      avatar: '/4b2dbb9454ca133be52e9d3f7d9ab87c840fb841.png'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <FadeInView className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              How CampusPe <span className="text-gradient">Platform Works</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeInView className="space-y-8">
              <h2 className="text-4xl font-bold text-gray-900">
                Save time with <span className="text-gradient">Automations</span>
              </h2>
