          ...
          <div className="flex justify-center mb-8">
            <div className="bg-white rounded-lg border border-gray-200 p-1 flex">
              <button
                ...
                className="px-4 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-colors"
              >
                Student
              </button>
              <button
              ...
              <button className="px-4 py-2 rounded-md text-sm font-medium bg-green-100 text-green-700 transition-colors">
                Company
              </button>
            </div>
          </div>
          
          <h1 className="text-3xl font-bold text-center text-green-700 mb-4">Company Registration</h1>
