            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white relative">
              ...
              <div className="w-full max-w-md">
                ...
                <div className="mb-6">
                  <button
                    disabled
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg bg-gray-50 text-gray-400 cursor-not-allowed"
                  >
                  ...
                  <p className="text-xs text-gray-500 text-center mt-2">Feature temporarily disabled</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <div className="text-center">
                    <button
                      type="button"
                      onClick={() => {
                        const userType = activeTab === 'company' ? 'recruiter' : activeTab;
