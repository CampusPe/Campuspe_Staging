                  ...
                  {activeTab === 'student' ? (
                    <div className="flex items-center justify-start">
                      <button
                        ...
                        className="inline-flex items-center gap-2 text-sm text-blue-700 border border-blue-300 hover:bg-blue-50 rounded-full px-3 py-1.5 transition-colors"
                      >
                ...
                {activeTab === 'student' && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-full bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors duration-200"
                    >
