...
```
WABB_WEBHOOK_URL=https://api.wabb.in/api/v1/webhooks-automation/catch/220/ORlQYXvg8qk9/
WABB_WEBHOOK_URL_RESUME=https://api.wabb.in/api/v1/webhooks-automation/catch/220/HJGMsTitkl8a/
...
1. API receives generate-and-share request
2. User not found → Triggers WABB webhook: `HJGMsTitkl8a`
3. WABB handles user registration flow
...
4. Resume sent to user's WhatsApp via WABB webhook
...
- Resume webhook: `HJGMsTitkl8a`
- General webhook: `ORlQYXvg8qk9`
